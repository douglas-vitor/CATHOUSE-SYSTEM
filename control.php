...
if (isset($_POST['l3'])){
	if ($bnt3==0){
		shell_exec('gpio write 27 0');
	}
	else {
		shell_exec('gpio write 27 1');
	}
}
...
$btn1 = exec('gpio read 17');
$btn2 = exec('gpio read 18');
$btn3 = exec('gpio read 27');
$btn4 = exec('gpio read 22');
$btn5 = exec('gpio read 23');
$btn6 = exec('gpio read 24');
$btn7 = exec('gpio read 25');
...
tipo8 = '<?php echo tiporea8(); ?>';
    ...
    if (aaa == 0 && tipo1 == tomada) {
        element2.style.backgroundColor = '#008000';
		element2.style.display = 'block';
    } else if (aaa == 1 && tipo1 == tomada) {  
    ...
    if (aa == 0 && tipo1 == tomada) {
        element2.style.backgroundColor = '#008000';
		element2.style.display = 'none';
    } else if (aa == 1 && tipo1 == tomada) {  
        element2.style.backgroundColor = '#FF0000';
		element2.style.display = 'block';
	} else if (tipo1 == luz) {
	element2.style.display = 'none';
    ...
    if (bbb == 0 && tipo2 == tomada) {
        element2.style.backgroundColor = '#008000';
	element2.style.display = 'block';
    } else if (bbb == 1 && tipo2 == tomada) {  
        element2.style.backgroundColor = '#FF0000';
	element2.style.display = 'none'; 
	} else if (tipo2 == luz) {
	element2.style.display = 'none';
    ...
    if (bb == 0 && tipo2 == tomada) {
        element2.style.backgroundColor = '#008000';
	element2.style.display = 'none';
    } else if (bb == 1 && tipo2 == tomada) {
        element2.style.backgroundColor = '#FF0000';
	element2.style.display = 'block';
        } else if (tipo2 == luz) {
	element2.style.display = 'none';
    ...
    if (ccc == 0 && tipo3 == tomada) {
        element3.style.backgroundColor = '#008000';
	element3.style.display = 'block';
    } else if (ccc == 1 && tipo3 == tomada) {  
    ...
    if (cc == 0 && tipo3 == tomada) {
        element3.style.backgroundColor = '#008000';
	element3.style.display = 'none';
    } else if (cc == 1 && tipo3 == tomada) {
        element3.style.backgroundColor = '#FF0000';
	element3.style.display = 'block';
        } else if (tipo3 == luz) {
	element3.style.display = 'none';
    ...
    if (ddd == 0 && tipo4 == tomada) {
        element4.style.backgroundColor = '#008000';
	element4.style.display = 'block';
    } else if (ddd == 1 && tipo4 == tomada) {  
    ...
    if (dd == 0 && tipo4 == tomada) {
        element4.style.backgroundColor = '#008000';
	element4.style.display = 'none';
    } else if (dd == 1 && tipo4 == tomada) {
        element4.style.backgroundColor = '#FF0000';
	element4.style.display = 'block';
        } else if (tipo4 == luz) {
	element4.style.display = 'none';
    ...
    if (eee == 0 && tipo5 == tomada) {
        element5.style.backgroundColor = '#008000';
	element5.style.display = 'block';
    } else if (eee == 1 && tipo5 == tomada) {  
    ...
    if (ee == 0 && tipo5 == tomada) {
        element5.style.backgroundColor = '#008000';
	element5.style.display = 'none';
    } else if (ee == 1 && tipo5 == tomada) {
        element5.style.backgroundColor = '#FF0000';
	element5.style.display = 'block';
        } else if (tipo5 == luz) {
	element5.style.display = 'none';
    ...
    if (fff == 0 && tipo6 == tomada) {
        element6.style.backgroundColor = '#008000';
	element6.style.display = 'block';
    } else if (fff == 1 && tipo6 == tomada) {  
    ...
    if (ff == 0 && tipo6 == tomada) {
        element6.style.backgroundColor = '#008000';
	element6.style.display = 'none';
    } else if (ff == 1 && tipo6 == tomada) {
        element6.style.backgroundColor = '#FF0000';
	element6.style.display = 'block';
        } else if (tipo6 == luz) {
	element6.style.display = 'none';
    ...
    if (gg == 0 && tipo7 == tomada) {
        element7.style.backgroundColor = '#008000';
	element7.style.display = 'none';
    } else if (gg == 1 && tipo7 == tomada) {
        element7.style.backgroundColor = '#FF0000';
	element7.style.display = 'block';
        } else if (tipo7 == luz) {
	element7.style.display = 'none';
    ...
    if (hh == 0 && tipo8 == tomada) {
        element8.style.backgroundColor = '#008000';
	element8.style.display = 'none';
    } else if (hh == 1 && tipo8 == tomada) {
        element8.style.backgroundColor = '#FF0000';
	element8.style.display = 'block';
        } else if (tipo8 == luz) {
	element8.style.display = 'none';
